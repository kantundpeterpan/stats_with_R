...
author: Heiner Atze
abstract: Final project for the first course in the *Statistics with R* specialization offered by Duke university on Coursera.
date: 2020-04-02 
---
# Setup
## Load packages
...
# Exploratory data analysis for variables associated with the research questions
...
![](images/b4a3e80f5bc46576560cf332cd3fcb6acb0c9631.png){.preview-image #fig-eda width=100%}
...
## **Is there an association between gender and income level?**
### Intro and objective
...
## **Is there an association between gender, income level and general health status?**
...
## **Is there and association between race (White, Black or African American, Asian), income level and general health status?**
